...
import { ShoppingCart, Package, LogOut, User, Store, LayoutDashboard, ShieldCheck } from 'lucide-react';
            ...
            <>
              ...
              {user.role === 'seller' && (
                ...
                >
                  ...
                  <span className="hidden sm:inline text-sm font-medium">Seller Dashboard</span>
                </Link>
              )}
              ...
              {user.role === 'admin' && (
                ...
                >
                  <ShieldCheck size={20} />
                  <span className="hidden sm:inline text-sm font-medium">Admin Dashboard</span>
                </Link>
              )}
              ...
              <div className="flex items-center gap-2 pl-3 ml-1 border-l border-slate-200">
                <div className="hidden sm:flex items-center gap-1.5 text-sm text-slate-500">
                  ...
                  {user.name.split(' ')[0]}
                  {user.role !== 'customer' && (
                    <span className="text-xs bg-slate-100 px-1.5 py-0.5 rounded capitalize">{user.role}</span>
                  )}
                </div>
                <button
